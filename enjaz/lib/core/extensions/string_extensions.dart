extension StringExtensions on String {
  ...
  /// Convert from "HH:MM:SS" → "HH:MM"
  String get removeSeconds {
    return substring(0, 5);
  }

  /// Convert from "HH:MM:SS.milliseconds" → DateTime.now()
  DateTime get toDateTimeParse {

      final now = DateTime.now();

      final onlyTime = removeSeconds;
